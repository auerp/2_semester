...
/**
 * Interface. Einfache Datenstruktur zur Verwaltung einer Reihe von Elementen.
 * 
 * @param <T>
...
public interface List<T> extends Iterable<T> {
	/**
	 * Ueerprueft, ob ein Element bereits vorhanden ist.
	 * 
	 * @param e
	 *            Element auf das geprueft werden soll
